...
function Home(){
    ...
    return(
        ...
        <motion.div  initial={{opacity: 0, y: 60}} 
                     ...
                     viewport={{once: true}} 
                     id="home">
            <div className="flex items-center justify-evenly gap-4 h-screen flex-wrap-reverse p-4 ">
            ...
            {/* Scroll Mouse */}
           <a href="#about"><BsMouse className="hidden lg:flex mouse hover:text-gray-800 cursor-pointer dark:hover:text-gray-300 dark:text-gray-500"/> </a>
        </motion.div>
        </>
    )
}
